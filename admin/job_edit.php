...
?>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="title" name="job_title" value="<?php echo $data['job_title'];?>">
  </div>
  <div class="form-group">
    ...
    <option value="<?php echo $data['contri'];?>">Select Country</option>
    </select>
    </div>
    <div class="form-group">
    <label for="my-textarea">State</label>
    <select name="state" class="states form-control" id="stateId"  name="state">
    <option value="<?php echo $data['state'];?>">Select State</option>
    </select>
    </div>
    <div class="form-group">
